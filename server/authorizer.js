...
Authorizer = function () {
  ...
  Authorizer.prototype.authorize_upload = function (arg) {
    var acl, bucket, expiration, expiration_date, file_name, file_size, file_type, key, meta_credential, meta_date, meta_uuid, path, policy, post_url, ref, ref1, ref2, ref3, ref4, region, signature;
